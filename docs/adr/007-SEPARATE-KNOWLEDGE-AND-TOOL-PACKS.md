...
The harness propagates the real caller identity to EIL. It never uses a broad service identity and never treats pack scoping as a substitute for ACL enforcement.
